/**
 * Sanctuary classic screen (the "2D" text-first surface). Moved verbatim
 * from the tab route in D7 -- the route now switches between this screen
 * and the diorama, and THIS screen is the permanent fallback (ADR 0011/
 * 0012): screen readers, Simple view, the render crash latch, and builds
 * without the diorama flag all land here.
 *
...
export function Sanctuary2DScreen() {
