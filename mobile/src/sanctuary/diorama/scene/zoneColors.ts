/**
 * Placeholder zone colors until the authored island art + zone sprite
 * palettes land. Mirrors the hue families of the 2D ZONE_TOKENS and the
 * pipeline palette (scripts/sanctuary_assets/palette).
 */
