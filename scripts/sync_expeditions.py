...
it points HINTERLAND_CONTENT_ROOT at content/expeditions/ here (an
explicitly set env var still wins) and delegates argv untouched.

Run from a machine with the same HINTERLAND_DATABASE_* env as the target
...
os.environ.setdefault("HINTERLAND_CONTENT_ROOT", str(_REPO_ROOT / "content" / "expeditions"))
